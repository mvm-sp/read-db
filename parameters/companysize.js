...
function buildAdd(req){
    ret.data = {dscompanysize: req.body.dscompanysize, vlrangeinit: req.body.vlrangeinit, vlrangefinal: req.body.vlrangefinal}
    ret.params = objToArray(ret.data);
    return ret;
}

function buildUpdate(req){
    ret.data = {id:req.params.id,dscompanysize: req.body.dscompanysize, vlrangeinit: req.body.vlrangeinit, vlrangefinal: req.body.vlrangefinal, active: req.body.active}
    ret.params = objToArray(ret.data);
    return ret;
}
